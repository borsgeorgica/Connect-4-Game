...
/**
 * 
 * A class that represents the current state of a Connect4 game, including the configuration of the
 * board and whose turn it is. The class is abstract and is to be extended by your own
...
public abstract class Connect4GameState {
  ...
  /**
   * Starts the game. Initialises every grid position in the board to EMPTY and sets the current
   * turn to RED
   */
   ...
   */
  public abstract int getCounterAt(int col, int row)
